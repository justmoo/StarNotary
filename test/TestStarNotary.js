...
it('lookUptokenIdToStarInfo test', async() => {
    ...
    let instance  = await StarNotary.deployed();
    await instance.createStar('Awesome Star!', tokenId, {from: accounts[0]})
     let tokenIdToStarInfo =await instance.tokenIdToStarInfo.call(tokenId)
     let lookUptokenIdToStarInfo = await instance.lookUptokenIdToStarInfo(tokenId)
    assert.equal(tokenIdToStarInfo, lookUptokenIdToStarInfo)
});